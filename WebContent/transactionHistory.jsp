...
<body>
	<h1>Recent Account Transaction History</h1>
	<c:if test="${customer.checkingAccount.transactionHistory != null}">
		<table class="table table-striped">
			<tr>
				<th>Date</th>
				<th>Amount</th>
			</tr>
			<c:forEach var="transaction" items="${customer.checkingAccount.transactionHistory}">
				<tr>
